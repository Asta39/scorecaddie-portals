...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    // Handle errors passed in the hash fragment (e.g., expired token)
    ...
    if (hash.includes('error=')) {
      ...
      if (errorDesc) {
        ...
        setError('Your activation link is invalid or has expired. Please ask your administrator to resend the invitation.')
      }
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-sm flex-col justify-center border-x border-border/50 *:px-6">
        ...
        <div className="flex flex-col space-y-6">
          <div className="flex items-center gap-3">
            <img src="/logo.png" alt="Score Caddie Logo" className="h-12 w-auto object-contain" />
            <h1 className="font-bold text-xl tracking-wide">Club Admin</h1>
          </div>
